# Contributing to [VoodooFinance.io](https://voodoofinance.io)

🎉 First off all, thanks to EVMOS for oeganizing this wonderful event! 🎉

Following is a set of guidelines for contributing to the `Voodoo.Finance` website. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
