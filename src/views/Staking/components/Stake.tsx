...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(voodooFinance.VSHARE, voodooFinance.contracts.Staking.address);

  const tokenBalance = useTokenBalance(voodooFinance.VSHARE);
  const stakedBalance = useStakedBalanceOnStaking();
  const { from, to } = useUnstakeTimerStaking();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('VSHARE', voodooFinance.VSHARE);
