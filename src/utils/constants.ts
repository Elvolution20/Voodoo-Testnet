export const VOODOO_TICKER = 'VOODOO';
export const VSHARE_TICKER = 'VSHARE';
export const VBOND_TICKER = 'VBOND';
export const EVMOS_TICKER = 'EVMOS';
export const WEVMOS_TICKER = 'WEVMOS';
